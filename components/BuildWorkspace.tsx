...
// Pre-computed so server and client render identical HTML (no hydration mismatch).
const CONFETTI_PIECES = Array.from({ length: 26 }, (_, i) => ({
  left: (((i * 13 + 7) * 17) % 100).toFixed(1),
  delay: (((i * 11 + 3) * 0.01) % 0.25).toFixed(3),
  dur: (1 + ((i * 7 + 5) % 90) / 100).toFixed(2),
  size: 6 + (i % 9),
}));
