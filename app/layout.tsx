  ...
  return (
    <html lang="en">
      <body className="font-sans antialiased">
        ...
        <link
          rel="stylesheet"
          href="https://fonts.googleapis.com/css2?family=Space+Grotesk:wght@500;700&family=Hanken+Grotesk:wght@400;500;600;700&family=JetBrains+Mono:wght@400;600&display=swap"
        />
        {children}
      </body>
    </html>
